    ...
    <section className="container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        <div className="flex gap-3 max-w-md">
          ...
          <button className="bg-blue-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-300"><BsArrowRight /></button>
        </div>
      </div>
