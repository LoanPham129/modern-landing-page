      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 hover:bg-blue-600 
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p className="text-gray-600 text-sm">Created by Loan Pham</p>
            </div>
        </div>
      </div>
    </footer>
